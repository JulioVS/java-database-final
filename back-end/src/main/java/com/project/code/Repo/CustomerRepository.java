...
public interface CustomerRepository extends JpaRepository<Customer, Long> {
    ...
    // Example: public interface CustomerRepository extends JpaRepository<Customer,
    // Long> {}
    ...
    // - You can create other query methods as needed, like finding customers by
    ...
    // - Mark the interface with @Repository to indicate that it's a Spring Data JPA
    // repository.
    // - This annotation is optional if you extend JpaRepository, as Spring Data
    // automatically registers the repository, but it's good practice to add it for
    // clarity.
