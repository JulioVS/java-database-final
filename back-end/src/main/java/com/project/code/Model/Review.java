...
// The class is annotated with @Document to indicate that it is a MongoDB document, 
// The 'id' field is marked with @Id to indicate that it is the primary key for the document.
...
public class Review {
    ...
    // 6. Add validation:
    // - Apply @NotNull to the customerId, productId, storeId, and rating fields to
    // ensure they are not null.
    // - Example: @NotNull(message = "Customer cannot be null")

    // 7. Add @Document annotation:
    // - Use @Document(collection = "reviews") to indicate that this class
    ...
    // - The 'id' field is of type String and will be automatically generated by
    // MongoDB.
    @Id
    private String id;

    // 10. Add Getters and Setters:
    // - Add getter and setter methods for all fields (customerId, productId,
